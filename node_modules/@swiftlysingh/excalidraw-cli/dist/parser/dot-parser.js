 ...
 */
function hasStyleValue(styleAttr, value) {
 ...
 */
function extractEdgeStyle(edge) {
    const style = {};
    let hasStyle = false;
...
function getNodeIdFromTarget(target) {
    ...
    if (typeof target === 'object' && 'id' in target && typeof target.id === 'string') {
        return target.id;
    }
    return null;
}
 ...
 */
function collectExplicitNodes(graph, explicitNodes) {
 ...
 */
function collectNodeIdsFromEdges(graph, nodeIds) {
 ...
 */
function collectEdges(graph, nodeMap, edges) {
 ...
 */
export function parseDOT(input) {
    let rootGraph;
    try {
...
//# sourceMappingURL=dot-parser.js.map